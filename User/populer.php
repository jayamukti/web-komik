...
<body>
    ...
    <div class="wrapper">
        <div class="navigationbar">
            <li style="padding: 15px 0 15px 15px;"><a style="margin-left: 10px; color: white;" href="index.php" type="text/css">BERANDA</li></a>
            <li><a href="populer.php" type="text/css" style="background-color: #413F3F; padding: 15px;">POPULER</a></li>
    ...
    <br><br><br>
    <div class="ad" style="background-color: #CC1C1C; width: 1100px; margin: auto; height: 1000px; border-radius: 22px; margin-top: 50px;">
        <br><br><br>
        <div class="ab">
            <p style="color: white; margin-left: 20px; font-size: large; font-weight: 600; padding: 9px;">Populer</p>
        </div>
