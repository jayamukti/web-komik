        ...
        <div class="list-user" style="border-radius: 10px; background-color: #CC1C1C; padding-top: 30px; padding-bottom: 30px; height: auto; width: 800px;">
            <table align="center" border="1" style="border-collapse: collapse; background-color: white;">
                ...
                <tr>
                    ...
                    <td><div style="background-color: #CC1C1C; color: white;">TAMBAH</div></td>
                    <td><a href="../delete.php?id_kategori=<?php echo $data['id_kategori']; ?>" onclick="return confirm('Data akan hilang, apakah anda yakin ?')" style="color: white; text-decoration: none; background-color: #CC1C1C; border: 1px solid black;">DELETE</a></td>
                </tr>
            <?php
            }
            ?>
